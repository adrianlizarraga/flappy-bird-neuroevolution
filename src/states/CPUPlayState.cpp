...
CPUPlayState::CPUPlayState(int width, int height)
...
CPUPlayState::~CPUPlayState() {

}

void CPUPlayState::addPipe() {
...
void CPUPlayState::cleanupPipes() {
    if (m_pipes.size() > 0) {
...
void CPUPlayState::handleEvent(sf::Event event) {
...
void CPUPlayState::update(float elapsed) {
...
void CPUPlayState::draw(sf::RenderWindow& window) const {
